...
<head>
<meta charset="utf-8">
<title> Search Filters My Cars</title>
<link rel="stylesheet"
...
<body>
  ...
  <div>
    <ul class="nav navbar-nav side-nav">
      <li><a href="MyCars.jsp"><i class="glyphicon glyphicon-hand-left"></i> Back</a></li>
    </ul>
  </div>
  <div>
    <ul class="nav navbar-nav side-nav">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header" style="margin-top: 10px; padding-top:10px;">
            Search Filters <small> My Car </small>
          </h1>           
          <div class="login-form-1">
            <form id="register-form" class="text-left" action="SearchFiltersMyCars">
              ...
              <div class="main-login-form">
                <div class="login-group">
                  ...
                  <a href="MyCars.jsp" class="tn btn-success btn-lg">Submit</a>
                </div>
            </form>
          </div>
        </div>
