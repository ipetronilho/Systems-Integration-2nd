...
<body>
  ...
  <div>
    <ul class="nav navbar-nav side-nav">
      <li><a href="FollowedCars.jsp"><i class="glyphicon glyphicon-hand-left"></i> Back</a></li>
    </ul>
  </div>
  <div>
    <ul class="nav navbar-nav side-nav">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="login-form-1">
            <form id="register-form" class="text-left" action="UnfollowFollowedCar">
              ...
              <div class="main-login-form">
                ...
                <a href="FollowedCars.jsp" class="tn btn-danger btn-lg">Unfollow Car</a>
        </div>
      </div>
    </div> 
  </div>
